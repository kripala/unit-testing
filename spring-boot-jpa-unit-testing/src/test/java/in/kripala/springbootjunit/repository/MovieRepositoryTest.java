...
public class MovieRepositoryTest {
	...
	void getMovieById() {
		...
		assertNotNull(newMovie);
		assertEquals("Action", newMovie.getGenere());
	...
	void getMoviesByGenere() {
		
		movieRepository.save(avatarMovie);
		movieRepository.save(titanicMovie);
		
		List<Movie> list = movieRepository.findByGenere("Romance");
	...
	void updateMovie() {
		...
		existingMovie.setGenere("Fantacy");
		Movie updatedMovie = movieRepository.save(existingMovie);
		
		assertEquals("Fantacy", updatedMovie.getGenere());
